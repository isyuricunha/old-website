    ...
    <div className="banner">
      ...
      <div className="container-fluid banner-content">
        <div className="name-wrapper">
          ...
          <p
            className={`section-description fade-right-sm ${
              showTitle ? "show" : ""
            }`}
          >
            {bannerDescription}
